...
public class EmailService implements IEmailService {
    ...
    private String generateHtml(Order order,
        ...
        html.append(
                ".info-box{background:#f5f5f5;padding:15px;margin:20px 0;border-radius:5px;border-left:4px solid #4CAF50;}");
        ...
        html.append(
                ".btn{display:inline-block;padding:10px 20px;margin:0 10px;border-radius:5px;text-decoration:none;font-weight:bold;font-size:14px;color:white;}");
        ...
        // Product table
        html.append(
                "<h3 style='color:#4CAF50;border-bottom:2px solid #4CAF50;padding-bottom:10px;'>📋 Order Details</h3>");
        html.append("<table>");
        ...
        // Delivery info
        html.append(
                "<h3 style='color:#4CAF50;border-bottom:2px solid #4CAF50;padding-bottom:10px;'>🚚 Delivery Information</h3>");
        html.append("<div class='info-box'>");
        ...
        html.append("<p><strong>Thank you for shopping with AIMS Store!</strong> 🛒</p>");
        html.append("<p>© 2026 AIMS Store. All rights reserved.</p>");
        html.append("</div>");

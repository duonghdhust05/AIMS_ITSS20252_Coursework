...
public class DeliveryInfoDialogUI {
    ...
    @FXML
    private TextField dialogPhoneField;
    @FXML
    private TextField dialogEmailField;
    @FXML
    private ComboBox<Province> dialogProvinceComboBox;
    @FXML
    private ComboBox<Ward> dialogWardComboBox;
    @FXML
    private TextArea dialogAddressArea;
    @FXML
    private TextArea dialogDeliveryInstructionsArea;
    @FXML
    private Label dialogDeliveryFeeLabel;
    @FXML
    ...
    // Error labels
    @FXML
    private Label dialogNameError;
    @FXML
    private Label dialogPhoneError;
    @FXML
    private Label dialogEmailError;
    @FXML
    private Label dialogProvinceError;
    @FXML
    private Label dialogWardError;
    @FXML
    private Label dialogAddressError;
    ...
    private void handleSave() {
        ...
        if (email.isEmpty()) {
            showError(dialogEmailError, "Please enter your email address");
            valid = false;

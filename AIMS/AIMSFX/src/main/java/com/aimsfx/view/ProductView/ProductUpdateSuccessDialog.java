    ...
    public void setProductInfo(Product product) {
        ...
        if (product instanceof Book) {
            ...
            if (book.getPublicationDate() != null)
                details.append("Publication Date: ").append(book.getPublicationDate()).append("\n");
            ...
            if (book.getCoverType() != null)
                details.append("Cover Type: ").append(book.getCoverType()).append("\n");
            ...
            if (cd.getRecordLabel() != null)
                details.append("Record Label: ").append(cd.getRecordLabel()).append("\n");
            if (cd.getGenre() != null)
                details.append("Genre: ").append(cd.getGenre()).append("\n");
            if (cd.getTrackCount() != null)
                details.append("Track Count: ").append(cd.getTrackCount()).append("\n");
            if (cd.getReleaseDate() != null)
                details.append("Release Date: ").append(cd.getReleaseDate()).append("\n");
            ...
            if (dvd.getStudio() != null)
                details.append("Studio: ").append(dvd.getStudio()).append("\n");
            if (dvd.getSubtitle() != null)
                details.append("Subtitle: ").append(dvd.getSubtitle()).append("\n");
            if (dvd.getDiscType() != null)
                details.append("Disc Type: ").append(dvd.getDiscType()).append("\n");
            if (dvd.getDuration() != null)
                details.append("Duration: ").append(dvd.getDuration()).append(" minutes\n");
            if (dvd.getGenre() != null)
                details.append("Genre: ").append(dvd.getGenre()).append("\n");
            if (dvd.getReleaseDate() != null)
                details.append("Release Date: ").append(dvd.getReleaseDate()).append("\n");
        } else if (product instanceof Newspaper) {
            Newspaper newspaper = (Newspaper) product;
            details.append("Newspaper Details:\n");
            if (newspaper.getIssn() != null)
                details.append("ISSN: ").append(newspaper.getIssn()).append("\n");
            if (newspaper.getFrequency() != null)
                details.append("Frequency: ").append(newspaper.getFrequency()).append("\n");
            if (newspaper.getEditorInChief() != null)
                details.append("Editor-in-Chief: ").append(newspaper.getEditorInChief()).append("\n");
            if (newspaper.getPublisher() != null)
                details.append("Publisher: ").append(newspaper.getPublisher()).append("\n");
            if (newspaper.getPublicationDate() != null)
                details.append("Publication Date: ").append(newspaper.getPublicationDate()).append("\n");
            if (newspaper.getLanguage() != null)
                details.append("Language: ").append(newspaper.getLanguage()).append("\n");
            if (newspaper.getSection() != null)
                details.append("Sections: ").append(newspaper.getSection()).append("\n");
        }
